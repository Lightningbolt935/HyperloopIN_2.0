...
const mentors = [
    { 
        ...
        image: '/images/mentors/Prabhu.jpg',
    ...
    { 
        ...
        role: 'Mentor', 
        department: 'Mechanical Engineering',
        image:'/images/mentors/Infanta.jpg'  ,
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    {mentors.map((mentor, index) => (
                        <SpotlightCard key={index} className="glass-card rounded-3xl p-8 text-center hover:bg-white/5 transition hover-trigger">
                            <div className="w-32 h-32 mx-auto rounded-full mb-6 overflow-hidden border-2 border-white/20">
                                <img 
                                    src={mentor.image} 
                                    alt={mentor.name}
